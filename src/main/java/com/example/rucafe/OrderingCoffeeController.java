...
public class OrderingCoffeeController implements Initializable {
    ...
    /**
     * Adds the specified Coffee object to the "Your Order" GUI and then resets the "Order Coffee" GUI data fields to
     * their default.
    ...
    /**
     * This method concurrently updates the subtotal of the coffee order as changes are made, and displays the resulting
     * total in the subTotal TextField.
     * @param event An ActionEvent object that occurs when an add-in is selected, when a size is selected, or when a
